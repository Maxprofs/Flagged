	  ...
	  private static final Predicate<Entity> IS_HANGING_ENTITY = new Predicate<Entity>()
	    {
	        ...
	        {
	            return p_apply_1_ instanceof EntityHangingSpecial || p_apply_1_ instanceof EntityHanging;
	        }
	    };
	    ...
	    public EntityHangingSpecial(World worldIn)
	    {
	        super(worldIn);
	        this.setSize(0.5f, 0.5f);
	    }

	    public EntityHangingSpecial(World worldIn, BlockPos hangingPositionIn)
	    {
	        this(worldIn);
	    ...
	    protected void updateBoundingBoxNEW()
	    {
	    	...
	    	if(facingDirection == null) facingDirection = EnumFacing.fromAngle(this.rotationYaw);
	        ...
	        if (this.facingDirection != null)
	        {
	        	...
	        	double d2 = (double)this.hangingPosition.getZ() + 1D;
	        	...
	        	d0 = d0 + (double)enumfacing.getFrontOffsetX();
	        	d2 = d2 + (double)enumfacing.getFrontOffsetZ();
